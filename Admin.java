...
public class Admin extends Person {
    ...
    public void deletecollegeallrounds(Connection connection, String InstituteName) {
        try {
            ...
            stmt.executeQuery("DELETE FROM round1 WHERE Institute = '" + InstituteName + "'");
            stmt.executeQuery("DELETE FROM round2 WHERE Institute = '" + InstituteName + "'");
            stmt.executeQuery("DELETE FROM round3 WHERE Institute = '" + InstituteName + "'");
            stmt.executeQuery("DELETE FROM round4 WHERE Institute = '" + InstituteName + "'");
            stmt.executeQuery("DELETE FROM round5 WHERE Institute = '" + InstituteName + "'");
            stmt.executeQuery("DELETE FROM round6 WHERE Institute = '" + InstituteName + "'");
